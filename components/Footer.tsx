      ...
      <div className="section-padding mx-auto grid gap-10 py-16 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-black">
            <li><Link href="/products" className="link-underline text-black">All Products</Link></li>
            <li><Link href="/categories" className="link-underline text-black">All Categories</Link></li>
            <li><Link href="/about" className="link-underline text-black">About Us</Link></li>
            <li><Link href="/stores" className="link-underline text-black">Stores</Link></li>
            <li><Link href="/franchise" className="link-underline text-black">Franchise</Link></li>
            <li><Link href="/contact" className="link-underline text-black">Contact Us</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-black">
            <li><Link href="/privacy-policy" className="link-underline text-black">Privacy Policy</Link></li>
            <li><Link href="/refund-policy" className="link-underline text-black">Refund Policy</Link></li>
            <li><Link href="/terms" className="link-underline text-black">Terms and Conditions</Link></li>
            <li><Link href="/shipping-policy" className="link-underline text-black">Shipping Policy</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="mt-4 space-y-3 text-sm text-black">
            <p className="flex items-start gap-2">
              <MapPin size={16} className="mt-0.5 text-black" />
              <span>
            ...
            <p className="flex items-center gap-2">
              ...
              <a href={BUSINESS_EMAIL_HREF} className="link-underline text-black">
                {BUSINESS_EMAIL}
              </a>
            </p>
            <p className="flex items-center gap-2">
